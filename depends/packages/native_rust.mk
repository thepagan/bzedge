...
# "darwin", in which case we assume -apple-darwin.
$(package)_rust_target_aarch64-pc-linux-gnu=aarch64-unknown-linux-gnu
...
define rust_target
$(if $($(1)_rust_target_$(2)),$($(1)_rust_target_$(2)),$(if $(findstring darwin,$(3)),aarch64-apple-darwin,$(if $(findstring freebsd,$(3)),aarch64-unknown-freebsd,$(2))))
endef
