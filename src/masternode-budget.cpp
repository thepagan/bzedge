...
int GetBudgetPaymentCycleBlocks()
{
    ...
    if (ChainNameFromCommandLine() == CBaseChainParams::MAIN) return (60*24*30); //1 month
...
std::vector<CBudgetProposal*> CBudgetManager::GetBudget()
{
    ...
    sort(vBudgetPorposalsSort.begin(), vBudgetPorposalsSort.end(), sortProposalsByVotes());
...
std::vector<CFinalizedBudget*> CBudgetManager::GetFinalizedBudgets()
{
    ...
    sort(vFinalizedBudgetsSort.begin(), vFinalizedBudgetsSort.end(), sortFinalizedBudgetsByVotes());
...
void CFinalizedBudget::AutoCheck()
{
    ...
    if (ChainNameFromCommandLine() == CBaseChainParams::MAIN && rand() % 4 != 0) {
